<div class="container container-background-fixed">
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Суперспособность</h2>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <h2><span class="glyphicon glyphicon-music" aria-hidden="true"></span> Суперспособность</h2>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <h2><span class="glyphicon glyphicon-screenshot" aria-hidden="true"></span> Суперспособность</h2>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <h2><span class="glyphicon glyphicon-blackboard" aria-hidden="true"></span> Суперспособность</h2>
